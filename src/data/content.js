...
export const overview = {
  ...
  notList: [
    ...
    { label: "Not a traditional LMS", detail: "Content is not generic e-learning; it is scaffolded employability coaching." },
...
export const researchStages = [
  {
    ...
    description:
      "Research into employability provision, work readiness, learner progression and the common challenges faced by job seekers — establishing the case for personalised support, stronger interview preparation and better visibility of readiness for tutors.",
  },
  {
    id: "stakeholder",
    title: "Stakeholder-Informed Reflection",
    description:
      "Professional knowledge of training, assessment, learner support and employability practice, alongside likely perspectives from tutors, job coaches and provider managers — surfacing large caseloads, mixed sector interests and limited tutor time.",
  },
  {
    id: "learner",
  ...
  },
  {
    ...
    description:
      "Findings were converted into six realistic learner personas, each representing a employability profile with genuine potential and motivation, but a different set of barriers to becoming work ready.",
  },
  {
    id: "design",
...
export const evidenceStats = [
  {
    ...
    detail: "UK 16–24 year olds not in education, employment or training, late 2025.",
    citation: "Reuters, 2025",
  },
  {
    value: "12.8%",
    label: "NEET rate",
    detail: "Proportion of 16–24 year olds NEET — a significant youth transition challenge.",
    citation: "Reuters, 2025",
  },
  {
    value: "14.7%",
  ...
  },
  {
    ...
    detail: "Only 57% of 2023–24 graduates were in full-time employment 15 months after finishing; 7% unemployed.",
    citation: "HESA / Times Higher Education, 2025",
  },
  {
    value: "36%",
    label: "Vacancies hit by skills shortages",
    detail: "UK skills shortages doubled between 2017 and 2022 to over half a million — 36% of all job vacancies.",
    citation: "Skills England, 2024–25",
  },
];
...
export const references = [
  { source: "Reuters, 2025", detail: "UK 16–24 NEET figures: 957,000 / 12.8% (late 2025)." },
  { source: "Government-commissioned review", detail: "~1 million NEET (one in eight); 60% had never held a job, versus 40% in 2005." },
  ...
  { source: "HESA / Times Higher Education, 2025", detail: "57% of 2023–24 graduates in full-time work 15 months on; 7% unemployed; 25% in other employment." },
  { source: "Skills England, 2024–25", detail: "UK skills shortages doubled 2017–2022 to 500,000+, accounting for 36% of vacancies." },
  { source: "UK labour-market vacancy analysis", detail: "11m UK vacancy study: AI-role demand +21% (2018–23), degree-requirement mentions −15%. 65m UK job-postings study: employers demand broader skill combinations." },
];
...
export const personas = [
  ...
  },
  {
    ...
    color: "amber",
    initials: "EC",
    bio: "Unemployed learner preparing for entry-level retail work after a short employability programme. She has informal customer-facing experience — greeting customers, arranging stock, simple transactions — but doesn't yet recognise it as strong employability evidence.",
    goals: [
    ...
    preferences: "Practical activities based on real retail situations, customer service scenarios, short tasks and voice-based responses, with non-judgemental instant feedback.",
    designImplications: [
  ...
  },
  {
    ...
    preferences: "Practical activities showing how skills are used in real office situations — templates, step-by-step prompts and instant feedback on accuracy, clarity and confidence.",
    designImplications: [
  ...
  },
  {
    ...
    preferences: "Practical, supportive activities based on realistic care situations — communicating with service users, responding calmly to concerns — with non-judgemental feedback.",
    designImplications: [
  ...
  },
  {
    ...
    color: "rose",
    initials: "RM",
    bio: "Career returner preparing to re-enter work after several years away. She previously worked in technology customer service support, but maternity leave, Covid disruption and a second pregnancy extended her time out of work. She now worries the sector — chatbots, automation, remote support, AI-assisted service tools — has moved on without her.",
    goals: [
    ...
    preferences: "Supportive, practical, confidence-building learning that connects previous experience to modern expectations — voice practice, mock interviews and scenario tasks.",
    designImplications: [
  ...
  },
  {
    ...
    preferences: "Practical, visual, scenario-based learning — site safety, teamwork, using tools responsibly, communicating with supervisors — with clear, non-judgemental feedback.",
    designImplications: [
...
export const modules = [
  ...
  },
  {
    ...
    aiRole: "Explains workplace expectations with simple examples, then adapts scenarios to the learner's sector (e.g. punctuality for care, confidentiality for cyber security).",
  ...
  },
  {
    ...
    aiRole: "Creates sector-relevant communication tasks — explaining a phishing risk, responding to a customer, speaking respectfully to a service user, writing a professional email.",
  ...
  },
  {
    ...
    aiRole: "Presents teamwork scenarios — supporting a colleague during a busy shift, a care handover, an IT incident, urgent paperwork — and helps learners reflect on their response.",
  ...
  },
  {
    ...
    aiRole: "Generates sector-based scenarios — escalating a suspicious email, handling a difficult customer, reporting a care concern, prioritising urgent admin tasks.",
  ...
  },
  {
    ...
    aiRole: "Helps learners identify transferable skills and rewrite experience professionally — e.g. family caring becomes evidence of responsibility, patience and communication.",
  ...
  },
  {
    ...
    evidenceOutput: "Completed mock interview responses, AI feedback record, improved answer drafts, confidence score before/after, interview readiness evidence.",
...
export const flippedFlow = {
  before: "Learners complete self-paced Zohapo activities — AI diagnostics, scenarios, communication practice, CV tasks, mock interviews and reflections.",
...
export const competitors = [
  ...
  },
  {
    ...
    gap: "Narrow focus on communication/interviews rather than a full employability curriculum.",
  ...
  },
  {
    ...
    focus: "AI-driven VR and web role-play for soft skills — communication, empathy, conflict resolution.",
    ...
    differentiator: "Zohapo works on any device with voice/text, and adds tutor analytics plus a passport.",
  },
  {
    name: "StandOut",
    ...
    gap: "Very narrowly focused on interviews only — no CV, teamwork or scenario content.",
  ...
  },
  {
    ...
    focus: "Web app generating interview questions from job descriptions, with audio/text practice.",
    strength: "Simple, low-cost, job-description tailored, voice-enabled.",
    gap: "Only addresses interview prep; no support for learners without a job description to input.",
    differentiator: "Zohapo personalises by sector even without a specific job advert, for whole cohorts.",
  },
  {
    name: "Pathful CRD",
    owner: "Pathful (USA)",
    focus: "Comprehensive K–16 career readiness platform with exploration, projects and mentorship.",
    strength: "Strong industry network (5,000+ partners); broad K-12 to adult coverage.",
    gap: "No AI; general rather than deep on specific employability skills.",
    differentiator: "Zohapo is AI-personalised and depth-focused on confidence, interview and evidence.",
  },
  {
    name: "Access Careers Centre",
    owner: "The Access Group (UK)",
    focus: "24/7 outplacement career platform — CV builder, interview practice, self-assessments.",
    strength: "Mature toolkit with deep corporate adoption.",
    gap: "No AI; self-guided e-learning; no tutor tools or modern UX.",
...
export const implementation = {
  ...
  timeline: [
    ...
    { phase: "Phase 3", title: "AI Coach Simulation & Dashboards", description: "Build AI coach, mock-interview and tutor dashboard mock-ups/prototypes." },
